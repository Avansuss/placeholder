...
De test is verlopen zoals het hoort. Wel had de robot enige moeite met het vermijden van de dynamische obstakels.

## Pass/Fail

* De robot kan handmatig rondrijden door middel van de logitech controller			X Pass    ☐ Fail
* Er kan een map worden gemaakt								X Pass    ☐ Fail
* De map kan worden opgeslagen								X Pass    ☐ Fail
* De map kan worden ingeladen								X Pass    ☐ Fail
* Er kan een locatie worden ingevuld op de nav goal node					X Pass    ☐ Fail
* De robot rijd autonoom naar de goal pose							X Pass    ☐ Fail
* De robot ontwijkt bekende obstakels (map)							X Pass    ☐ Fail
* De robot ontwijkt statische onbekende obstakels (doos)					X Pass    ☐ Fail
* De robot ontwijkt dynamische onbekende obstakels (rondlopende mensen)		X Pass    ☐ Fail
